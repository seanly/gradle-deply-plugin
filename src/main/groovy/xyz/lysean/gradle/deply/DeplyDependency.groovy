...
class DeplyDependency {

    private static final String OVERRIDE_PROJECT_PROPERTY = 'deply.dependenciesVersion'
    private static final String DEFAULT_DEPENDENCIES_VERSION = 'latest.release'
    private static final GString DEFAULT_DEPENDENCIES_YAML = "xyz.lysean.gradle.deply:deply-dependencies:${DEFAULT_DEPENDENCIES_VERSION}@yml"
    ...
    DeplyDependency(Project project) {
